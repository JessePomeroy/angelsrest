...
<style>
  @layer components {
    ...
    .desktop-selection { font-size: var(--text-base); line-height: var(--text-base--line-height); font-weight: 400; color: var(--color-surface-700); }
    :global(.dark) .desktop-selection { color: var(--color-surface-200); }
    .selection-prompt { font-size: var(--text-base); line-height: var(--text-base--line-height); color: var(--color-surface-700); }
    :global(.dark) .selection-prompt { color: var(--color-surface-200); }
    ...
    .mobile-selection { flex: 1 1 12ch; min-inline-size: 0; overflow-wrap: anywhere; font-size: var(--text-xs); line-height: var(--text-xs--line-height); color: var(--color-surface-700); }
    :global(.dark) .mobile-selection { color: var(--color-surface-200); }
    .mobile-selection-prompt { font-size: var(--text-sm); line-height: var(--text-sm--line-height); color: var(--color-surface-700); }
    :global(.dark) .mobile-selection-prompt { color: var(--color-surface-200); }
