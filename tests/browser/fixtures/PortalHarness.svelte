...
function createData(): PageData {
  if (kind === "fractional" || kind === "invalid-invoice") return { ...base, type: "invoice", document: { _creationTime: 1_700_000_000_000, invoiceNumber: "INV-FRACTION", status: "sent", items: [{ description: "Half hour A", quantity: kind === "fractional" ? 0.5 : 0, unitPrice: 1999 }, { description: "Half hour B", quantity: 0.5, unitPrice: 1999 }], taxPercent: 6.25 } };
